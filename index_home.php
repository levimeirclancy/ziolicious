...
//		$html_temp .= '<a href="/photo/"><div class="photo-row-img-container photo-row-img-transition-one" style="background-image: url(\''.$img_array[0].'\');"></div></a>';
		...
		$html_temp .= '<a href="/photo/"><img class="photo-row-img photo-row-img-transition-one" src="'.$img_array[1].'"></a>';
		$html_temp .= '<a href="/photo/"><img class="photo-row-img photo-row-img-transition-one" src="'.$img_array[2].'"></a>';
